...
default_cfgs = {
    ...
    'vit_small_patch16_224_augreg_in1k': _cfg(
        ...
        hf_hub_id='timm/',
        custom_load=True),
    'vit_small_patch16_384_augreg_in1k': _cfg(
    ...
    'vit_base_patch32_224_augreg_in1k': _cfg(
        ...
        hf_hub_id='timm/',
        custom_load=True),
    'vit_base_patch32_384_augreg_in1k': _cfg(
    ...
    'vit_base_patch16_224_augreg_in1k': _cfg(
        ...
        hf_hub_id='timm/',
        custom_load=True),
    'vit_base_patch16_384_augreg_in1k': _cfg(
    ...
    'vit_tiny_patch16_224_augreg_in21k_ft_in1k': _cfg(
        url='https://storage.googleapis.com/vit_models/augreg/Ti_16-i21k-300ep-lr_0.001-aug_none-wd_0.03-do_0.0-sd_0.0--imagenet2012-steps_20k-lr_0.03-res_224.npz',
        hf_hub_id='timm/',
        custom_load=True),
    'vit_tiny_patch16_384_augreg_in21k_ft_in1k': _cfg(
        url='https://storage.googleapis.com/vit_models/augreg/Ti_16-i21k-300ep-lr_0.001-aug_none-wd_0.03-do_0.0-sd_0.0--imagenet2012-steps_20k-lr_0.03-res_384.npz',
        hf_hub_id='timm/',
        custom_load=True, input_size=(3, 384, 384), crop_pct=1.0),
    'vit_small_patch32_224_augreg_in21k_ft_in1k': _cfg(
        ...
        hf_hub_id='timm/',
        custom_load=True),
    'vit_small_patch32_384_augreg_in21k_ft_in1k': _cfg(
        ...
        hf_hub_id='timm/',
        custom_load=True, input_size=(3, 384, 384), crop_pct=1.0),
    'vit_small_patch16_224_augreg_in21k_ft_in1k': _cfg(
        url='https://storage.googleapis.com/vit_models/augreg/S_16-i21k-300ep-lr_0.001-aug_light1-wd_0.03-do_0.0-sd_0.0--imagenet2012-steps_20k-lr_0.03-res_224.npz',
        hf_hub_id='timm/',
        custom_load=True),
    'vit_small_patch16_384_augreg_in21k_ft_in1k': _cfg(
        ...
        hf_hub_id='timm/',
        custom_load=True, input_size=(3, 384, 384), crop_pct=1.0),
    'vit_base_patch32_224_augreg_in21k_ft_in1k': _cfg(
        ...
        hf_hub_id='timm/',
        custom_load=True),
    'vit_base_patch32_384_augreg_in21k_ft_in1k': _cfg(
        ...
        hf_hub_id='timm/',
        custom_load=True, input_size=(3, 384, 384), crop_pct=1.0),
    'vit_base_patch16_224_augreg_in21k_ft_in1k': _cfg(
        url='https://storage.googleapis.com/vit_models/augreg/B_16-i21k-300ep-lr_0.001-aug_medium1-wd_0.1-do_0.0-sd_0.0--imagenet2012-steps_20k-lr_0.01-res_224.npz',
        hf_hub_id='timm/',
        custom_load=True),
    'vit_base_patch16_384_augreg_in21k_ft_in1k': _cfg(
        ...
        hf_hub_id='timm/',
        custom_load=True, input_size=(3, 384, 384), crop_pct=1.0),
    'vit_base_patch8_224_augreg_in21k_ft_in1k': _cfg(
        ...
        hf_hub_id='timm/',
        custom_load=True),
    'vit_large_patch16_224_augreg_in21k_ft_in1k': _cfg(
        url='https://storage.googleapis.com/vit_models/augreg/L_16-i21k-300ep-lr_0.001-aug_medium1-wd_0.1-do_0.1-sd_0.1--imagenet2012-steps_20k-lr_0.01-res_224.npz',
        hf_hub_id='timm/',
        custom_load=True),
    'vit_large_patch16_384_augreg_in21k_ft_in1k': _cfg(
    ...
    'vit_base_patch16_224_clip_laion2b': _cfg(
        # hf_hub_id='laion/CLIP-ViT-B-16-laion2B-s34B-b88K',
        # hf_hub_filename='open_clip_pytorch_model.bin',
        file="/home/user02/LiuSH/01tongue/工学/新mtl组合-tongue/权重文件夹/open_clip_pytorch_model.bin",
        mean=OPENAI_CLIP_MEAN, std=OPENAI_CLIP_STD, num_classes=512),
...
def _create_vision_transformer(variant, pretrained=False, **kwargs):
    ...
    model = build_model_with_cfg(
        ...
        # pretrained_custom_load="/home/user02/LiuSH/02classif+ood/新ood+mtl组合/权重文件夹/open_clip_pytorch_model.bin",
...
# @register_model
# def vit_small_patch16_224_augreg_in1k(pretrained=False, **kwargs):
#     """ ViT-Small (ViT-S/16)
#     NOTE I've replaced my previous 'small' model definition and weights with the small variant from the DeiT paper
#     """
#     model_kwargs = dict(patch_size=16, embed_dim=384, depth=12, num_heads=6, **kwargs)
#     model = _create_vision_transformer('vit_small_patch16_224_augreg_in1k', pretrained=pretrained, **model_kwargs)
#     return model
#
#
# @register_model
# def vit_small_patch16_224_augreg_in21k_ft_in1k(pretrained=False, **kwargs):
#     """ ViT-Small (ViT-S/16)
#     NOTE I've replaced my previous 'small' model definition and weights with the small variant from the DeiT paper
#     """
#     model_kwargs = dict(patch_size=16, embed_dim=384, depth=12, num_heads=6, **kwargs)
#     model = _create_vision_transformer('vit_small_patch16_224_augreg_in21k_ft_in1k', pretrained=pretrained, **model_kwargs)
#     return model
#
#
# @register_model
...
#     model = _create_vision_transformer('vit_base_patch16_224_augreg_in1k', pretrained=pretrained, **model_kwargs)
#     return model
#
#
# @register_model
# def vit_base_patch16_224_augreg_in21k_ft_in1k(pretrained=False, **kwargs):
#     """ ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
#     ImageNet-1k weights fine-tuned from in21k @ 224x224, source https://github.com/google-research/vision_transformer.
#     """
#     model_kwargs = dict(patch_size=16, embed_dim=768, depth=12, num_heads=12, **kwargs)
#     model = _create_vision_transformer('vit_base_patch16_224_augreg_in21k_ft_in1k', pretrained=pretrained, **model_kwargs)
#     return model


@register_model
def vit_base_patch16_224_clip_laion2b(pretrained=False, **kwargs):
    """ ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    """
    model_kwargs = dict(
        patch_size=16, embed_dim=768, depth=12, num_heads=12, pre_norm=True, norm_layer=nn.LayerNorm, **kwargs)
    model = _create_vision_transformer('vit_base_patch16_224_clip_laion2b', pretrained=pretrained, **model_kwargs)
    return model


# @register_model
# def vit_large_patch16_224_augreg_in21k_ft_in1k(pretrained=False, **kwargs):
#     """ ViT-Large model (ViT-L/16) from original paper (https://arxiv.org/abs/2010.11929).
#     ImageNet-1k weights fine-tuned from in21k @ 224x224, source https://github.com/google-research/vision_transformer.
#     """
#     model_kwargs = dict(patch_size=16, embed_dim=1024, depth=24, num_heads=16, **kwargs)
#     model = _create_vision_transformer('vit_large_patch16_224_augreg_in21k_ft_in1k', pretrained=pretrained, **model_kwargs)
#     return model
#
#
# @register_model
# def vit_large_patch14_224_clip_laion2b(pretrained=False, **kwargs):
#     """ ViT-Base (ViT-L/14) from original paper (https://arxiv.org/abs/2010.11929).
#     """
#     model_kwargs = dict(
